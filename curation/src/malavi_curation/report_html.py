...
FINDING_HEADLINES = {
    ...
    "site_coordinates_unreadable": "{subjects}: the coordinates could not be read",
    "site_outside_country": "{subjects}: the coordinates fall outside the named country",
    "site_country_not_in_atlas": "{subjects}: the country is not in the atlas, coordinates not tested",
